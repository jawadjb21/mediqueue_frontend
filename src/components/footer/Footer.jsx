        ...
        <div className="grid gap-10 lg:grid-cols-5">
          ...
          <div className="lg:col-span-2">
            <div className="flex items-center gap-3">
              ...
              <div>
                <h2 className="text-3xl font-bold text-primary">MediQueue</h2>
              </div>
            </div>

            <p className="mt-4 max-w-md text-muted-foreground">
              Making quality education accessible for everyone. Connect with
              expert tutors and book learning sessions seamlessly.
            </p>
          </div>
          ...
          <div>
            <h3 className="mb-4 font-semibold text-primary">Contact Us</h3>
          ...
          <div className="flex flex-col gap-6 md:flex-row md:items-center md:justify-between">
            <div>
              ...
              <p className="mt-2 text-muted-foreground">
                Get notified about new tutors, subjects, and learning resources.
              </p>
            </div>
