          ...
          <Card>
            <CardContent className="flex items-center gap-4 p-6">
              ...
              <div>
                ...
                <p className="text-2xl font-bold">${tutor.fee}</p>
              </div>
            </CardContent>
          </Card>
          ...
          <Card>
            <CardContent className="flex items-center gap-4 p-6">
              ...
              <div>
                ...
                <p className="font-semibold">{tutor.subject}</p>
              </div>
            </CardContent>
          </Card>
          ...
          <Card>
            <CardContent className="flex items-center gap-4 p-6">
              ...
              <div>
                ...
                <p className="font-semibold">{tutor.mode}</p>
              </div>
            </CardContent>
          </Card>
          ...
          <Card>
            <CardContent className="flex items-center gap-4 p-6">
              ...
              <div>
                ...
                <p className="font-semibold">{tutor.slot}</p>
              </div>
            </CardContent>
          </Card>
        </div>
      ...
      <section className="container mx-auto px-4 pb-16">
        <Card>
          <CardContent className="p-8">
            <h2 className="mb-6 text-2xl font-bold">Availability</h2>

            <div className="mb-6 flex items-center gap-2 text-muted-foreground">
              <Calendar className="size-4" />
              Starting from {new Date(tutor.start).toLocaleDateString()}
            </div>

            <div className="flex flex-wrap gap-3">
              {tutor.days?.map((day) => (
                <Badge key={day} variant="outline" className="px-4 py-2">
                  {day}
                </Badge>
              ))}
            </div>
