  ...
  return (
    <Card className="w-full max-w-sm container mx-auto my-auto">
      <div className="flex items-center justify-center mb-4">
        <Image src={Logo} alt="MediQueue" className="h-14 w-14" />
        <span className="mt-2 text-primary font-bold text-2xl">MediQueue</span>
      </div>
      <CardHeader>
          ...
          <div className="flex flex-col gap-6">
            <div className="grid gap-2">
              ...
              <Input
                autoFocus
                className={
                  "h-11 rounded-xl border-border focus-visible:ring-primary"
                }
                id="name"
                type="text"
              ...
              <div className="relative">
                <Input
                  className={
                    "h-11 rounded-xl border-border focus-visible:ring-primary pr-10"
                  }
                  id="password"
      ...
      <CardFooter className="flex-col gap-2">
        <Button
          variant="outline"
          className="h-11 w-full rounded-xl hover:bg-muted"
